# -*- coding: utf-8 -*-
"""
Created on Fri Jul  1 11:30:56 2016

@author: kevin_000

Adaptation of the LeNet5 neural network architecture from the Theano tutorial

Includes fully connected hidden layer class and logistic regression class
...
class LeNetConvPoolLayer(object):
    ...
    def __init__(self, rng, filter_shape, poolsize=(2, 2)):
        """
    ...
    def forward(self,input,image_shape):
        ...
        '''
        # Forward pass: convolve input feature maps with filters
        conv_out = conv2d(
            input=input,
            filters=self.W,
...
## Fully connected hidden layer (multilayer perceptron)
##
...
## logistic regression + softmax output layer
##
